...
%global project         layeh
%global repo            gopher-luar
# https://github.com/layeh/gopher-luar
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     layeh.com/gopher-luar
%global commit          6a6a71f079f7e727b5331cd48cf3dfc6028743c7
%global shortcommit     %(c=%{commit}; echo ${c:0:7})
%global commitdate      20170713

Name:           golang-%{project}-%{repo}
Version:        1.0.1
Release:        1%{?dist}
...
Requires:      golang(github.com/yuin/gopher-lua)
