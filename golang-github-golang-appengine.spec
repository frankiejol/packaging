...
%global commit          ad2570cd3913654e00c5f0183b39d2f998e54046
%global shortcommit     %(c=%{commit}; echo ${c:0:7})

Name:           golang-%{provider}-%{project}-%{repo}
Version:        0
Release:        0.1.git%{shortcommit}%{?dist}
Summary:        Provides APIs for interacting with App Engine services
# Detected licences
...
%gotest %{import_path}
%gotest %{import_path}/aetest
%gotest %{import_path}/blobstore
%gotest %{import_path}/channel
%gotest %{import_path}/cmd/aefix
%gotest %{import_path}/datastore
%gotest %{import_path}/delay
# Success in local, fail in mock
...
%changelog
* Mon Jul 24 2017 Robert-André Mauchin <zebob.m@gmail.com> - 0-0.1.gitad2570c
