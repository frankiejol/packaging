...
%global repo            readline
# https://github.com/chzyer/readline
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     gopkg.in/readline.v1
%global commit          62c6fe6193755f722b8b8788aa7357be55a50ff1
%global shortcommit     %(c=%{commit}; echo ${c:0:7})
%global commitdate      20160726

Name:           golang-gopkg-readline
Version:        1.4
Release:        1%{?dist}
...
Requires:      golang(github.com/chzyer/test)
...
%dir %{gopath}/src/gopkg.in/readline.v1
%endif
