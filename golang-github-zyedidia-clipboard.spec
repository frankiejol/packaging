...
%global with_debug 0
# Tests are outdated, api changed
%global with_check 0
...
%global repo            clipboard
# https://github.com/zyedidia/clipboard
%global provider_prefix %{provider}.%{provider_tld}/%{project}/%{repo}
%global import_path     %{provider_prefix}
%global commit          adacf416cec40266b051e7bc096c52951f2725e9
%global shortcommit     %(c=%{commit}; echo ${c:0:7})
%global commitdate      20161226
...
Patch0:         clipboard-adacf41-fix_import.patch
